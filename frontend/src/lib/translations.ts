export const translations = {
	en: {
		...
		noItemsAdded: "No items added to this session yet",
		...
		dangerousActionsDesc: "Careful with these actions as they affect the entire database",
		generateSeedData: "Generate Seed Data",
		confirmSeed: "Are you sure? This will delete all existing data and generate new test data.",
		upgradePlan: "Upgrade Plan",
		cancelAndRefund: "Cancel & Refund",
		howToRefund: "How would you like to refund?",
		refundWarning: "Refunds cannot be undone. Balance refunds add to the customer's wallet immediately.",
		...
		upgradeNote: "Upgrading will start a new billing cycle.",
		invoice: "Invoice",
	...
	ar: {
		...
		ignoreAndContinue: "تجاهل والاستمرار",
		...
		editInventory: "تعديل منتجات الجلسة",
		noItemsAdded: "لم يتم إضافة أي منتجات لهذه الجلسة بعد",
		...
		dangerousActionsDesc: "كن حذراً مع هذه الإجراءات لأنها تؤثر على قاعدة البيانات بالكامل",
		generateSeedData: "توليد بيانات تجريبية",
		confirmSeed: "هل أنت متأكد؟ سيتم حذف جميع البيانات الحالية وتوليد بيانات تجريبية جديدة.",
		upgradePlan: "ترقية الخطة",
		cancelAndRefund: "إلغاء واسترداد",
		howToRefund: "كيف تود استرداد المبلغ؟",
		refundWarning: "لا يمكن التراجع عن الاسترداد. يضاف الرصيد لمحفظة العميل فوراً.",
		refundToBalance: "استرداد للرصيد",
		refundCash: "استرداد نقدي",
		withdraw: "سحب",
		withdrawBalance: "سحب الرصيد",
		enterWithdrawAmount: "أدخل المبلغ المراد سحبه",
		invalidAmount: "مبلغ غير صحيح",
		upgradeNote: "الترقية ستبدأ دورة فوترة جديدة.",
		invoice: "فاتورة",
		withdrawal: "سحب",
		refund: "استرداد",
	},
