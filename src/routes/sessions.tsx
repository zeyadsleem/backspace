                          ...
                          <div className="p-6 pt-0">
                            <ScrollArea className="h-[60vh] pr-4">
                              <div className="space-y-8">
                                ...
                                <div className="flex justify-between text-2xl font-bold bg-primary/5 p-4 rounded-xl border-2 border-primary/20">
                                ...
                                <Button className="w-full text-base h-10" size="default">
