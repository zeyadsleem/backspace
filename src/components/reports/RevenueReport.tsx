    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="rounded-xl border border-stone-200 bg-white p-4 dark:border-stone-800 dark:bg-stone-900">
          ...
          <p className="mt-1 font-bold text-2xl text-amber-600 dark:text-amber-400">
        ...
        <div className="rounded-xl border border-stone-200 bg-white p-4 dark:border-stone-800 dark:bg-stone-900">
          ...
          <div className="mt-1 flex items-center gap-2">
            ...
            <p
              className={`font-bold text-2xl ${isPositive ? "text-emerald-600 dark:text-emerald-400" : "text-red-600 dark:text-red-400"}`}
            >
              {isPositive ? "+" : ""}
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        <div className="rounded-xl border border-stone-200 bg-white p-5 lg:col-span-2 dark:border-stone-800 dark:bg-stone-900">
            ...
            {revenueChart.map((point, index) => {
              ...
              return (
                <div className="flex flex-1 flex-col items-center gap-1" key={index}>
                  ...
                  >
                    <div
                      className="w-full max-w-8 rounded-t bg-amber-500"
