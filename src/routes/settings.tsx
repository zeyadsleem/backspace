...
export default function SettingsPage() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-4 max-w-6xl" dir={dir}>
              ...
              <div className="grid grid-cols-3 gap-2">
                {[
                  ...
                  <button
                    ...
                    className={cn(
                      "flex flex-col items-center gap-1.5 p-2 rounded-md border-2 transition-all hover:scale-105",
                      theme === item.mode
          ...
          <Card className="border-2 shadow-sm rounded-lg">
            <CardContent className="p-4">
              <div className="flex items-center gap-2 mb-3">
                ...
                <h3 className="text-sm font-extrabold">{t("settings").notifications[language]}</h3>
              </div>
