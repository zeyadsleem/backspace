...
export namespace models {
	...
	export class PaginatedResult_myproject_backend_models_Customer_ {
	    items: Customer[];
	    total: number;
	    page: number;
	    pageSize: number;
	    ...
	    static createFrom(source: any = {}) {
	        return new PaginatedResult_myproject_backend_models_Customer_(source);
	    }
	
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.items = this.convertValues(source["items"], Customer);
	        this.total = source["total"];
	...
	export class PaginatedResult_myproject_backend_models_Invoice_ {
	    items: Invoice[];
	    total: number;
	    page: number;
	    pageSize: number;
	    ...
	    static createFrom(source: any = {}) {
	        return new PaginatedResult_myproject_backend_models_Invoice_(source);
	    }
	
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.items = this.convertValues(source["items"], Invoice);
	        this.total = source["total"];
	        this.page = source["page"];
	        this.pageSize = source["pageSize"];
	        this.totalPages = source["totalPages"];
